...
#Editar la informacion del ususario
select = True
while select :
    print("Decesas cambiar algo de tu perfil?")
    print("Si")
    print("No")

    election = str(input("Elige una opciÃ³n: "))

    if  election == "Si" or election == "sI" or election == "SI" or election == "si" or election == "s" or election == "S":
        edicion = True
        select = False
    elif election == "No" or election == "nO" or election == "NO" or election == "no" or election == "n" or election == "N":
        edicion = False
        select = False
    else:
...
while edicion:
    ...
    print("3. Modificar estatura")
    print("4. Mostrar perfil")
    print("5. Salir")
    selection = int(input("Elige una opciÃ³n: "))

    if selection == 1:
        nombre = input("Dime tu nuevo nombre: ")
    elif selection == 2:
        edad = int(input("Dime tu nueva edad: "))
    elif selection == 3:
        estatura = float(input("Dime tu nueva estatura en metros: "))
        estatura_m = int(estatura)
        estatura_cm = int( (estatura - estatura_m)*100 )
    elif selection == 4:
        print()
        ...
        print("por favor elija una opciÃ³n vÃ¡lida")
...
while continuar:
    ...
    #AsÃ­, en la siguiente iteraciÃ³n el ciclo terminarÃ¡
        ...
        print("No conozco esa opciÃ³n. Por favor, elija S o N.")
