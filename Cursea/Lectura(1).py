...
Lugar_nacimiento = input("Ahora dime dÃ¡nde vives. ")
print()
...
genero = input("Dime que genero eres Hombre o Mujer. ")
print()
...
telefono_cel = int(input("Ahora dime tu numero de telefono sin el +569. "))
cel = "+569" + str(telefono_cel)
print()
